    ...
    <div class="content-wrapper">
        @if (session('status'))
            <div id="alert-messenger" class="alert alert-info" style="position: absolute; z-index: 4; right: 0; bottom: 50px;">
                <svg aria-hidden="true" class="svg-icon iconClearSm" style="cursor: pointer; margin-right: 20px; fill: #fff;"
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-md-9 col-sm-12">
                        <ol class="breadcrumb float-sm-right"
                            style="display: flex; flex-direction: row; min-width: 420px; width: 100%; justify-content: flex-end;">
                            <button type="button" class="btn btn-block btn-success"
                                style=" max-height: 38px; margin-top: 0; max-width: 180px; min-width: 120px; margin-right: 10px;"
                                id="addInstance"><i class="fas fa-plus" style="margin-right: 5px;"></i> Adicionar
                                Instância</button>
                            <button type="button" class="btn btn-block btn-primary"
                                style="max-height: 38px; margin-top: 0; max-width: 230px; min-width: 120px; margin-right: 10px;"
                                id="openPopupBtn3"><i class="fas fa-plus" style="margin-right: 5px;"></i> Nova resposta
                                automâtica</button>
            ...
            <div class="opoup-container">
                <form action="{{ route('add-instance') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="session" class="form-control" id="exampleInputEmail1"
                            placeholder="Nome">
                    </div>
                    <div class="form-group" data-select2-id="29">
                        <label>Velocidade de envio de mensagem</label>
                        <select name="speed" class="form-control select2 select2-hidden-accessible"
                            style="width: 100%; z-index: 1000000000000000000000000000000000000000000000000;"
                    ...
                    <div class="card-footer" style="display: flex; justify-content: right;">
                        <button type="button" class="btn btn-block btn-default"
                            style="margin-right: 20px; max-width: 100px;" id="cancelInstance">Cancelar</button>
    ...
    <div class="overlay" id="popupOverlay-2">
        ...
        <div class="popup-content-2">
            <div class="content-header" style="padding: 0;">
                <div class="container-fluid">
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right"
                                style="display: flex; flex-direction: row; min-width: 420px;">
            ...
            <form action="{{ route('responders.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-footer" style="display: flex; justify-content: right;">
                    <button type="button" class="btn btn-block btn-default"
                        style="margin-right: 20px; max-width: 100px;" id="closePopupBtncan">Cancelar</button>
